...
public class DashboardPage extends WebPage {
        ...
        if(bookingPagesList.size() > 0) {
            for(WebElement element : bookingPagesList) {
                ...
                if(text.equals(bookingPageName)) {
                    clickDeleteButtonFunction(element);
                    break;
                }
            }
            sleepInSeconds(2);
            ...
            System.out.println(bookingPagesSizeAfterDelete);
        }
    }
    ...
    public void clickDeleteButtonFunction(WebElement element) {
        ...
        deleteButton.click();
        WebElement deleteConfirmCheckbox = getWebElement("#typeDelete");
